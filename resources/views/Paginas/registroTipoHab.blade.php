                ...
                <div class="modal-content">
                    <div class="modal-header" style="background:-webkit-linear-gradient(left top,#FFC300  ,#2980B9);">
                        <h5 class="modal-title" style="align-content: center" id="exampleModalLabel">Formulario de
                            Registro de Tipo de Habitación  </h5>
                    ...
                    <form action="{{ route('registrarTipoHab') }}" method="POST">
                        @csrf
                        @method('POST')
                        <div class="row">
                            <div class="col-6 offset-3">
                                <div class="form-group">
                                    <label>Categoria de la Habitación:</label>
                                    <input type="text" name="descripcion" class="form-control"
                                           placeholder="Ingresa el tipo de Habitacion ">
                                </div>
                            </div>
                        </div>
